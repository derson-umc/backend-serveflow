...
public class ProductRecipe {
    ...
    public ProductRecipe(UUID id, UUID productId, String productName,
        ...
        this.id = Objects.requireNonNull(id, "ID da ficha técnica e obrigatório.");
        this.productId = Objects.requireNonNull(productId, "ID do produto e obrigatório.");
        if (productName == null || productName.isBlank())
            throw new IllegalArgumentException("Nome do produto e obrigatório.");
    ...
    public void addIngredient(RecipeIngredient ingredient) {
        ...
        if (alreadyExists)
            throw new IllegalStateException("Insumo ja existe nesta ficha técnica.");
    ...
    public void removeIngredient(UUID ingredientId) {
        ...
        if (!removed)
            throw new IllegalArgumentException("Ingrediente nao encontrado na ficha técnica.");
    }
